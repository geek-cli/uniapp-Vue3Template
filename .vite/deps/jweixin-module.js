...
// ../../../Desktop/开发常用工具/uniapp-Scaffolding/uniapp-Vue3Template/node_modules/jweixin-module/lib/index.js
      ...
      if (!o.jWeixin) {
        var n, c = { config: "preVerifyJSAPI", onMenuShareTimeline: "menu:share:timeline", onMenuShareAppMessage: "menu:share:appmessage", onMenuShareQQ: "menu:share:qq", onMenuShareWeibo: "menu:share:weiboApp", onMenuShareQZone: "menu:share:QZone", previewImage: "imagePreview", getLocation: "geoLocation", openProductSpecificView: "openProductViewWithPid", addCard: "batchAddCard", openCard: "batchViewCard", chooseWXPay: "getBrandWCPayRequest", openEnterpriseRedPacket: "getRecevieBizHongBaoRequest", startSearchBeacons: "startMonitoringBeacons", stopSearchBeacons: "stopMonitoringBeacons", onSearchBeacons: "onBeaconsInRange", consumeAndShareCard: "consumedShareCard", openAddress: "editAddress" }, a = function() {
          ...
          for (var n2 in c)
            e2[c[n2]] = n2;
          return e2;
        }(), i = o.document, t = i.title, r = navigator.userAgent.toLowerCase(), s = navigator.platform.toLowerCase(), d = !(!s.match("mac") && !s.match("win")), u = r.indexOf("wxdebugger") != -1, l = r.indexOf("micromessenger") != -1, p = r.indexOf("android") != -1, f = r.indexOf("iphone") != -1 || r.indexOf("ipad") != -1, m = (n = r.match(/micromessenger\/(\d+\.\d+\.\d+)/) || r.match(/micromessenger\/(\d+\.\d+)/)) ? n[1] : "", g = { initStartTime: L(), initEndTime: 0, preVerifyStartTime: 0, preVerifyEndTime: 0 }, h = { version: 1, appId: "", initTime: 0, preVerifyTime: 0, networkType: "", isPreVerifyOk: 1, systemType: f ? 1 : p ? 2 : -1, clientVersion: m, url: encodeURIComponent(location.href) }, v = {}, S = { _completes: [] }, y = { state: 0, data: {} };
        O(function() {
          g.initEndTime = L();
        });
        var I = false, _ = [], w = { config: function(e2) {
          ...
          P(c.onMenuShareAppMessage, { complete: function(e2) {
            e2.scene === "favorite" ? M("sendAppMessage", { title: n2.title || t, desc: n2.desc || "", link: n2.link || location.href, img_url: n2.imgUrl || "", type: n2.type || "link", data_url: n2.dataUrl || "" }) : M("sendAppMessage", { title: n2.title || t, desc: n2.desc || "", link: n2.link || location.href, img_url: n2.imgUrl || "", type: n2.type || "link", data_url: n2.dataUrl || "" }, n2);
          } }, n2);
          ...
          M("uploadVoice", { localId: e2.localId, isShowProgressTips: e2.isShowProgressTips == 0 ? 0 : 1 }, e2);
        }, downloadVoice: function(e2) {
          M("downloadVoice", { serverId: e2.serverId, isShowProgressTips: e2.isShowProgressTips == 0 ? 0 : 1 }, e2);
        }, translateVoice: function(e2) {
          M("translateVoice", { localId: e2.localId, isShowProgressTips: e2.isShowProgressTips == 0 ? 0 : 1 }, e2);
          ...
          M("uploadImage", { localId: e2.localId, isShowProgressTips: e2.isShowProgressTips == 0 ? 0 : 1 }, e2);
        }, downloadImage: function(e2) {
          M("downloadImage", { serverId: e2.serverId, isShowProgressTips: e2.isShowProgressTips == 0 ? 0 : 1 }, e2);
...
// dep:jweixin-module
init_define_process_env_UNI_STAT_TITLE_JSON();
var jweixin_module_default = require_lib();
export {
  jweixin_module_default as default
};
