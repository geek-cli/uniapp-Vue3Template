<template>
	<view class="sku" v-if="isV3 ? modelValue : value" @click="isMaskClose ? close : ''">
		<view class="shopSpecsPopup">
			<image class="close" src="../static/img/sku/close.png" @click="close"></image>
			<view class="content">
				...
				<view class="number flex f-y-c f-x-b">
					...
					<znx-numBox :width="200" integer v-model="num" :minValue="selectSku.stock == 0 ? 0 : 1" :maxValue="selectSku.id ? selectSku.stock : showAreaStock[1]"></znx-numBox>
				</view>
